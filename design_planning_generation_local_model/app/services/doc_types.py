...
# 基础上传格式（始终支持，使用本地解析器）
# 注意：.md 为纯文本，本地解析器可直接读取，始终支持，无需 MinerU
_BASE_UPLOAD_FORMATS = [".docx", ".pdf", ".txt", ".pptx", ".md"]
...
# ── DHF 文件清单（胰岛素泵-DHF清单.xlsx 提取，2026-09-21；
#    模板上传「目标文档类型」下拉与此清单文件名称保持一致）──
DHF_DOC_FILE_TYPES = [
    ("设计策划", "市场调研(临床需求)和产品定义"),
    ("设计策划", "项目可行性研究报告（技术、商业、合规、成本、医保政策等）"),
    ("设计策划", "专利分析报告"),
    ("设计策划", "立项及评审"),
    ("设计策划", "注册路径策略"),
    ("设计策划", "项目开发计划书"),
    ...
    ("设计输入", "软件设计需求"),
    ("设计输入", "包装及标识设计需求"),
    ("设计输入", "产品开发追溯表/产品需求追溯矩阵（RTM）"),
    ("设计输入", "软件开发追溯表/软件需求追溯矩阵"),
    ("设计输入", "网络安全追溯表"),
    ("设计输入", "医疗器械安全和性能基本原则（EP）清单"),
    ("设计输出", "硬件设计方案"),
    ("设计输出", "结构设计方案"),
    ("设计输出", "软件设计方案"),
    ("设计输出", "软件编码规范"),
    ...
    ("设计输出", "网络安全风险分析和管理总表"),
    ("设计输出", "DFMEA"),
    ("设计输出", "产品开发追溯表/需求追溯矩阵（RTM）"),
    ("设计输出", "软件开发追溯表/软件需求追溯矩阵"),
    ("设计输出", "网络安全追溯表"),
    ("设计输出", "初包装材料选择与确认报告"),
    ("设计输出", "性能研究相关记录"),
    ("设计输出", "产品技术要求"),
    ...
    ("设计输出", "BOM表"),
    ("设计输出", "物料规格书、图纸"),
    ("设计输出", "产品图纸（爆炸图）、结构/零件/组件图纸"),
    ("设计输出", "工艺流程图"),
    ("设计输出", "标签、使用说明书"),
    ("设计输出", "设备（生产、检验设备清单及相应验证、操作SOP）"),
    ("设计输出", "工装图纸、工装验收记录"),
    ("设计输出", "原材料进货检验规范、过程检验规范、成品出厂检验规范"),
    ("设计输出", "生产工艺作业指导书"),
    ("设计输出", "软件版本包"),
    ("设计输出", "供应商资质、原材料生物相容性报告等"),
    ("设计输出", "合格供应商清单"),
    ("设计输出", "设计输出清单"),
    ("设计验证", "设计验证计划"),
    ("设计验证", "性能验证方案"),
    ...
    ("设计验证", "产品风险分析和管理总表"),
    ("设计验证", "网络安全风险分析和管理总表"),
    ("设计验证", "产品开发追溯表/产品需求追溯矩阵（RTM）"),
    ("设计验证", "软件开发追溯表/软件需求追溯矩阵"),
    ("设计验证", "网络安全追溯表"),
    ("设计验证", "生物相容性试验报告、药液相容性试验报告"),
    ("设计验证", "安规、EMC、环境可靠性等强制检测"),
    ("设计验证", "注册检验报告"),
    ("设计转换", "工艺验证计划"),
    ("设计转换", "设计转换计划"),
    ("设计转换", "灭菌确认方案"),
